    ...
    <body>
        <?php
            class tabla
            {
                ...
                //podemos definir un valor por defecto en el constructor o dejar sin valor para más tarde mandarle ese valor.
                ...
                // Declaración de un método(funcion)
                //esta funcion añade un div con un color variable
