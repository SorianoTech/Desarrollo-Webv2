    ...
    <body>
        ...
        <section id="alta_profesor">
            <form method="post" action="guardar_profesor.php">
                <fieldset>
                    <legend>Nuevo Profesor/a <button onclick="abrir('profesores')"> [ + ] </button></legend>
                    <div id="profesores">
                        ...
                        <table>
                            <thead>
                                <tr>
                                    <th>Nombre</th><th>Telefono</th><th>Mail</th><th>Materias</th><th></th>
                                </tr>
                            </thead>
                            <?php
        ...
        <section id="alta_materia">
            <form method="post" action="guardar_materia.php">
                <fieldset>
                    <legend>Nueva materia <button onclick="abrir('materias')"> [ + ] </button></legend>
                    <div id="materias">
        ...
        <section id="alta_alumno">
            <form method="post" action="guardar_alumno.php">
                <fieldset>
                    <legend>Nuevo Alumno/a <button onclick="abrir('alumnos')"> [ + ] </button></legend>
                    <div id="alumnos">
                        ...
                        <table>
                            <thead>
                                <tr>
                                    <th>Nombre</th><th>Telefono</th><th>Mail</th><th></th>
                                </tr>
                            </thead>
                            <?php
