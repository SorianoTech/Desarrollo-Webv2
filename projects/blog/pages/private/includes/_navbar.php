<nav class="navbar col-lg-12 col-12 p-0 fixed-top d-flex flex-row">
      <div class="text-center navbar-brand-wrapper">
        <a class="navbar-brand brand-logo" href="post.php"><img src="../../images/dev.svg" alt="logo"></a>
        <a class="navbar-brand brand-logo-mini" href="post.php"><img src="../../images/dev.svg"
            alt="logo"></a>
      </div>
      <div class="navbar-menu-wrapper d-flex align-items-center">
        ...
        <p class="page-name d-none d-lg-block">Hola, <? echo ucfirst(usuario(($_COOKIE['usuario'])))?></p>
